    ...
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<Post, PostViewDto>().ForMember(c => c.LikeCount, opt => opt.MapFrom(c => c.Likes.Count))
                                         ...
                                         .ForMember(c => c.IsFollow, opt => opt.Ignore())
                                         ...
                                         .ForMember(c => c.Polarity, opt => opt.MapFrom(c => Convert.ToString(Decimal.Round(Decimal.Parse(c.Polarity), 2))))
                                         .ForMember(c => c.SourceLanguageCode, opt => opt.MapFrom(c => c.SourceLanguageCode))
                                         .ReverseMap();
